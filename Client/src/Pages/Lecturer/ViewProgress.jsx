  ...
  return (
    <div className="w-full h-screen bg-gray-100 flex flex-col items-center justify-center">
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 bg-white shadow-md rounded-lg">
        <h2 className="text-3xl font-semibold mb-4 text-center">Live Student Progress</h2>
        <div className="mb-6">
          <p className="text-lg"><strong>Contest Name:</strong> {contest.name}</p>
            ...
            <div key={student.regNo} className="p-4 border rounded-lg shadow-sm bg-gray-50">
              <div className="flex flex-col justify-between h-full">
                ...
                <div className="text-right mt-4">
                  <p className="text-2xl font-bold">{student.totalGrade}</p>
