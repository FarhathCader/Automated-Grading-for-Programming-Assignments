...
const Feed = () => {
  ...
  return (
    <section className="w-full min-h-screen flex justify-center items-center bg-gray-100">
      <div className="w-11/12 sm:w-4/5 bg-white rounded-xl shadow-lg p-4 sm:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-violet-700 mb-4 text-center">Dashboard</h1>
        <div className="mb-6 flex flex-col items-center justify-center text-gray-600">
          ...
          <div className="flex justify-center items-center gap-4 flex-wrap">
            <Link to="/available">
              <button className="bg-blue-500 text-white px-4 sm:px-6 py-2 rounded-md hover:bg-blue-600 focus:outline-none">
                Available Contests
              </button>
            </Link>
            <Link to="/practice">
              <button className="bg-green-500 text-white px-4 sm:px-6 py-2 rounded-md hover:bg-green-600 focus:outline-none">
                Start Practice
              </button>
            </Link>
          </div>
        ...
        <div className="mt-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4 text-center">Upcoming Contests</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {upcomingContests.map((contest) => (
              <div key={contest._id} className="bg-white rounded-lg shadow-md p-4">
                <h3 className="text-md sm:text-lg font-semibold text-gray-800 mb-2">{contest.name}</h3>
      ...
      {showContestDetails && (
        <div className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white w-11/12 sm:w-96 p-8 rounded-lg shadow-md">
            <h1 className="text-2xl sm:text-3xl font-semibold mb-4 text-center">{activeContest.name}</h1>
            <p className="text-base sm:text-lg mb-4 text-center">Total Problems: {activeContest.problems.length}</p>
            <p className="text-base sm:text-lg mb-6 text-center">Starts in: {timeRemaining}</p>
            <button
              className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none"
