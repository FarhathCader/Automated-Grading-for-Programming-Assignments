...
describe("POST /api/contest", () => {
    ...
    describe("DELETE /api/contest/:id", () => {
        ...
        const res = await request(app).delete(`/api/contest/${contest.body.contest._id}`);
...
describe("PUT /api/contest/:id", () => {
    it("should update a contest", async () => {
        ...
        const updatedContest = {
            ...
            endDate: "2022-12-16",
            duration: 2,
            problems: ["663f9338bd0be4761e098aba", "663f9338bd0be4761e098aba", "663f9338bd0be4761e098abc"],
        };
...
describe("GET /api/contest/:id", () => {
    it("should get a contest by id", async () => {
        ...
        const res = await request(app).get(`/api/contest/${contest.body.contest._id}`);
